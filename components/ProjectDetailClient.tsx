              ...
              <div className="animate-fade-right">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    ...
                    className={`relative overflow-hidden inline-flex items-center justify-center gap-2 sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r ${getTypeColor(
                      project.type,
            ...
            <div className="animate-fade-up">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`group relative inline-flex items-center justify-center gap-3 sm:w-auto px-6 sm:px-10 py-3 sm:py-5 bg-gradient-to-r ${getTypeColor(
                    project.type,
