              ...
              <div className="animate-fade-right">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className={`block text-center py-4 px-6 bg-gradient-to-r ${getTypeColor(
                      project.type,
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block text-center py-4 px-6 border-2 border-gray-600 text-gray-300 rounded-xl font-semibold text-lg"
                  >
                    View Code
                  </a>
                </div>
