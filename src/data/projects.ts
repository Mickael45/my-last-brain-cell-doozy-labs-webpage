...
export const mockProjects: Project[] = [
  {
    ...
    description: 'A task management app so smart, it probably judges your life choices. Uses AI to predict when you\'ll actually do that thing you\'ve been putting off for 3 months. Spoiler alert: it\'s not today.',
    ...
    techStack: ['React', 'TypeScript', 'Node.js', 'TensorFlow.js', 'PostgreSQL'],
  ...
  },
  {
    ...
    description: 'Turns your messy codebase into beautiful visualizations that make you feel like a data scientist. Warning: May cause existential crisis when you realize how many TODO comments you have.',
    projectUrl: 'https://codesnap.example.com',
    imageUrl: 'https://images.pexels.com/photos/6424589/pexels-photo-6424589.jpeg?auto=compress&cs=tinysrgb&w=800',
    screenshots: [
  ...
  },
  {
    ...
    description: 'A digital playground where neural networks experiment with creativity and occasionally achieve sentience. Results may include abstract art that looks suspiciously like your childhood trauma.',
  ...
  },
  {
    id: '4',
    title: 'Quantum Notes',
    tagline: 'Notes that exist in multiple dimensions (and none of them make sense)',
    description: 'A note-taking app that uses quantum physics principles to organize your thoughts. Your notes might be in superposition until you observe them. Schrödinger\'s productivity app.',
  ...
  },
  {
    ...
    description: 'An emotion detection system so advanced, it can tell you\'re dead inside just from your typing patterns. Now with 47 different types of existential dread classification!',
  ...
  },
  {
    ...
    description: 'Transforms boring data into trippy visualizations that look like they belong in a sci-fi movie. Your quarterly reports have never looked so psychedelic.',
    projectUrl: 'https://data-dreamscape.example.com',
    imageUrl: 'https://images.pexels.com/photos/8439087/pexels-photo-8439087.jpeg?auto=compress&cs=tinysrgb&w=800',
    screenshots: [
